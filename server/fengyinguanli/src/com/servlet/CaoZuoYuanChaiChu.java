...
public class CaoZuoYuanChaiChu extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			List<CaoZuoYuanChaiChuClass> dingdans = serv.caozuoyuanchaichu(caozuoyuan,timekaishi,timejieshu);
			StringBuffer sb = new StringBuffer();
			sb.append('[');
			for(CaoZuoYuanChaiChuClass dingdan : dingdans){
