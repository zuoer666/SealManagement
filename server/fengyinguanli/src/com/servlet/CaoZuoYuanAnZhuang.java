...
public class CaoZuoYuanAnZhuang extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			List<CaoZuoYuanAnZhuangClass> dingdans = serv.caozuoyuananzhuang(caozuoyuan,timekaishi,timejieshu);
			StringBuffer sb = new StringBuffer();
			sb.append('[');
			for(CaoZuoYuanAnZhuangClass dingdan : dingdans){
