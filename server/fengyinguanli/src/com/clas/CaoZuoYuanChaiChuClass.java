...
public class CaoZuoYuanChaiChuClass {
	String dianbiaohao;
    ...
    public CaoZuoYuanChaiChuClass(String dianbiaohao,String chaichushijian, String dili, String dianbiaoxiang ,String fengyinhao) {
