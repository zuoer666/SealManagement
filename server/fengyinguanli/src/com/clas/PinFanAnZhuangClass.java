...
public class PinFanAnZhuangClass {
	String dianbiaohao;
    ...
    public PinFanAnZhuangClass(String dianbiaohao,String anzhungshijian, String dili, String dianbiaoxiang ,String fengyinhao) {
