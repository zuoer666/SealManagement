...
public class CaoZuoYuanAnZhuangClass {
	 	String dianbiaohao;
	    ...
	    public CaoZuoYuanAnZhuangClass(String dianbiaohao,String anzhungshijian, String dili, String dianbiaoxiang ,String fengyinhao) {
